...
const char *WINDOWTITLE = "Jacob CS 557 Final";
...
Display( )
{
	...
	Pattern.SetUniformVariable((char*)"uA", NowAmp);
	Pattern.SetUniformVariable((char*)"uP", NowPhase);
	Pattern.SetUniformVariable((char*)"lightPosX", 2.0);
	Pattern.SetUniformVariable((char*)"lightPosY", 1.0);
	Pattern.SetUniformVariable((char*)"lightPosZ", -3.0);
	Pattern.SetUniformVariable((char*)"wrap", NowWrap);


	glCallList( SphereList );
	//glCallList(CurtainList);
...
InitGraphics( )
{
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_DEPTH_COMPONENT, 600, 600,
	...
	Pattern.Use( );
	Pattern.SetUniformVariable( (char *)"uKa", 0.01f );
	Pattern.SetUniformVariable( (char *)"uKd", 0.8f );
...
InitLists( )
{
	...
	// curtain
	CurtainList = glGenLists(1);
	glNewList(CurtainList, GL_COMPILE);
	LoadObjFile("cow.obj");
